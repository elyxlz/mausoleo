...
<style>
  ...
  .unit.collapsed { margin-bottom: .25em; padding: .2em .5em; display: flex; gap: .5em; align-items: baseline; }
  ...
  .hltext { font-weight: bold; flex: 0 1 auto; min-width: 0; overflow-wrap: anywhere; }
  .hltext.empty { font-weight: normal; color: #b00; font-style: italic; }
  .unit:not(.collapsed) .hltext { display: none; }
  .chars { color: #888; font: 11px monospace; flex: 0 0 auto; }
  .snip { color: #777; font-size: .85em; flex: 1 1 0; overflow: hidden; text-overflow: ellipsis;
          white-space: nowrap; min-width: 4em; }
  .unit:not(.collapsed) .snip { display: none; }
  .unit.offpage { opacity: .5; }
  .unit { cursor: grab; }
  .unit.dragging { opacity: .4; }
  .unit.dropbefore { box-shadow: 0 -3px 0 #4da3ff; }
  .unit.dropafter { box-shadow: 0 3px 0 #4da3ff; }
