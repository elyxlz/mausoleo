...
- **Corpus-scale budget (3× raise 2026-07-21, per Elio; was 6.9–13.9)**: full-corpus OCR (1880–1959, 172,600 pages measured on endeavour) on 2×3090 → **target 20.7, hard cap 50.0 GPU-s/page steady-state** (~3 weeks / ~6 weeks max). Every experiment records steady-state GPU-s/page; >50.0 is a research artifact, not production. Measured cold+independent (no reusing prior experiments' caches).
