...
## Standing context
- Metric = **MausoleoBench** (`src/mausoleo/eval/evaluate.py`). Budget cap = **250.0 sec/page**, caller-measured (`scripts/time_experiment.sh`); `BUDGET_CAP` in `scripts/progress_server.py` is the single source of truth.
