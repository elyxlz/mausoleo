...
- **Corpus-scale budget**: full-corpus OCR (1880–1959, 172,600 pages) on 2×3090 → **target 20.7, hard cap 50.0 sec/page**. Budget is measured by the caller (`scripts/time_experiment.sh`), not the experiment; >50.0 is a research artifact, not production.
